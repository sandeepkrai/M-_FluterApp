  ...
  loadImageData() async {
    for (int index = 1; index < images.length; index++) {
      final Uint8List markerIcon =
          await getBytesFromAssets(images[index], 125, 125);
      setState(() {
        _marker.add(
          Marker(
...
//Current Location Mapping Marking//
  ...
  static const _initialCameraPosition = CameraPosition(
    target: LatLng(
        13.344842, 74.786309), //13.344842, 74.786309 //13.35053, 74.793568
    zoom: 15.4746,
  );
...
//LIST:LIST:LIST:LIST:LIST//
  ...
  List<String> images = [
    ...
    'assets/images/drone-delivery.png',
  ...
  List<LatLng> _latlng = [
    const LatLng(13.350486, 74.793765),
    const LatLng(13.3529363, 74.7882884),
    const LatLng(13.3444152, 74.7944426)
  ];
...
//Polygons
  ...
  List<LatLng> _polyLatlng = [
    const LatLng(13.3444152, 74.7944426),
    const LatLng(13.35053, 74.793568),
    const LatLng(13.352987, 74.791623),
    const LatLng(13.3529363, 74.7882884)
  ];
